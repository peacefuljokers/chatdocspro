...
function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    default-src 'self' 'unsafe-inline' 'unsafe-eval' https://elegant-ferret-44.clerk.accounts.dev/ https://chatdocspro.s3.ap-southeast-1.amazonaws.com/ https://clerk.chatdocspro.com/;
